...
class UserInvoicesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('Dashboard.User.Invoices.create', compact('contacts', 'admins', 'locations','customers','suppliers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Dashboard.User.Invoices.edit', compact('Invoices', 'suppliers', 'customers', 'admins', 'locations', 'contacts'));
    }
    ...
    public function cancel(Request $request)
    {
     ...
     public function show($id)
     {
        ...
        return view('Dashboard.User.Invoices.showinvoice', compact('invoice', 'serials','productSerialCounts'));
    }
