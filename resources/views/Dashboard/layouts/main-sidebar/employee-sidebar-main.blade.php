				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{route('employee.invoices.completed')}}">قائمة الاذون المكتملة</a></li>
