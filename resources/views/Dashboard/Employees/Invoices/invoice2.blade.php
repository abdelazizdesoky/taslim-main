...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الاذون </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ استلام</span>
						</div>
					</div>
		...
		<div class="col-md-12 col-lg-8 col-xl-8">
			<div class="card card-table-two">
				<div class="d-flex justify-content-between">
					<h4 class="card-title mb-1"><h4>الاذون استلام    </h4></h4>
					<i class="mdi mdi-truck-fast text-gray"><label class="tx-13"> عدد الاذون -{{$activeInvoicesCount}}</label>	</i>
				</div>
